...
// Removed useState for isResetConfirmOpen as AlertDialog handles its own state via trigger
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export const UserDetailModal: FC<UserDetailModalProps> = ({ isOpen, onClose, userData, onAction }) => {
  // const [isResetConfirmOpen, setIsResetConfirmOpen] = useState(false); // No longer needed
  ...
  return (
            ...
            <div className="space-y-4">
                ...
                <Card>
                    ...
                    <CardContent className="grid grid-cols-2 gap-3">
                        ...
                        {/* Confirmation Dialog for Reset Progress - Corrected Structure */}
                        <AlertDialog>
    ...
    // The separate AlertDialog component that was here before is now integrated above.
  );
};
