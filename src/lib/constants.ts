...
export const TIER_DATA: TierDetail[] = [
  { name: "Nông Dân Tập Sự",        icon: "🌱", colorClass: "bg-green-500 hover:bg-green-600 text-green-50", levelStart: 1 },
  { name: "Chủ Vườn Chăm Chỉ",      icon: "🧑‍🌾", colorClass: "bg-lime-500 hover:bg-lime-600 text-lime-900", levelStart: 11 }, // Darker text for lime
  { name: "Nhà Trồng Trọt Khéo Léo", icon: "🌿", colorClass: "bg-teal-500 hover:bg-teal-600 text-teal-50", levelStart: 21 },
  { name: "Chuyên Gia Mùa Vụ",      icon: "🌾", colorClass: "bg-yellow-400 hover:bg-yellow-500 text-yellow-900", levelStart: 31 }, // Darker text for yellow
  { name: "Bậc Thầy Nông Sản",      icon: "🏆", colorClass: "bg-amber-400 hover:bg-amber-500 text-amber-900", levelStart: 41 }, // Darker text for amber
  { name: "Lão Nông Uyên Bác",      icon: "🦉", colorClass: "bg-orange-500 hover:bg-orange-600 text-orange-50", levelStart: 51 },
  { name: "Phú Nông Giàu Có",        icon: "💰", colorClass: "bg-red-500 hover:bg-red-600 text-red-50", levelStart: 61 },
  { name: "Hoàng Gia Nông Nghiệp",   icon: "👑", colorClass: "bg-purple-500 hover:bg-purple-600 text-purple-50", levelStart: 71 },
  { name: "Thần Nông Tái Thế",      icon: "✨", colorClass: "bg-pink-500 hover:bg-pink-600 text-pink-50", levelStart: 81 },
  { name: "Huyền Thoại Đất Đai",    icon: "🌟", colorClass: "bg-indigo-500 hover:bg-indigo-600 text-indigo-50", levelStart: 91 },
];
